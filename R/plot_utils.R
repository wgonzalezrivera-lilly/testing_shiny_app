plot_finemap_pip <- function(data, position_range, pip_threshold, credible_set_threshold) {
	...
	visible$in_credible_set <- visible$SNP %in% ordered$SNP[ordered$in_credible_set]
